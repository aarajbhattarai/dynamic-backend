...
export interface ElementsJobVacancy extends Schema.Component {
  collectionName: 'components_elements_job_vacancies';
  info: {
  ...
  attributes: {
    ...
    category: Attribute.Relation<
      'elements.job-vacancy',
      'oneToOne',
      'api::category.category'
    >;
    numberOfApplicant: Attribute.Integer;
...
export interface ElementsPayments extends Schema.Component {
  ...
  attributes: {
    invoiceNumber: Attribute.BigInteger;
...
export interface SectionsJobSeeker extends Schema.Component {
  collectionName: 'components_sections_job_seekers';
  info: {
...
export interface SectionsJobVacancies extends Schema.Component {
  collectionName: 'components_sections_job_vacancies';
  info: {
    displayName: 'Job Vacancies';
    description: '';
  };
  attributes: {
    title: Attribute.String;
    jobVacancy: Attribute.Component<'elements.job-vacancy', true>;
  };
}
...
export interface SectionsStatistics extends Schema.Component {
  collectionName: 'components_layout_statistics';
  info: {
  ...
  attributes: {
    heading: Attribute.String;
    description: Attribute.Text;
    statistics: Attribute.Component<'elements.statistic', true>;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'elements.job-vacancy': ElementsJobVacancy;
      'elements.logos': ElementsLogos;
      'elements.notification-banner': ElementsNotificationBanner;
      'elements.payments': ElementsPayments;
      ...
      'sections.job-seeker': SectionsJobSeeker;
      'sections.job-vacancies': SectionsJobVacancies;

...
export interface ApiNavbarNavbar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    links: Attribute.Component<'shared.menu-item', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    slug: Attribute.UID<'api::navbar.navbar', 'label'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    articles: Attribute.Relation<
      ...
      'api::article.article'
    >;
    contactFormDisplay: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    articleDisplay: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
